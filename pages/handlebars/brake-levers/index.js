  ...
  return(
    <div>
      <>
        <Layout>
          <Container>
            <h1 className="main-headline text-6xl font-bold mb-8 pt-10 mb-8">brake levers.</h1>
            ...
            {
              morePosts.length > 0 && <ProductPage posts={morePosts} uidName="brake-levers" apiName="Handlebars" />
            }
          </Container>
        </Layout>
      </>
